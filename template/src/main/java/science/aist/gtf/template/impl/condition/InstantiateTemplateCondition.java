...
/**
 * <p>Renderer condition for Instantiate Task</p>
 *
 * @author Andreas Schuler
 * @since 1.0
 */
public class InstantiateTemplateCondition implements RendererCondition<TemplateTask> {

    @Override
    public Predicate<TemplateTask> createCondition() {
        return element -> TemplateTaskTypeEnum.TEMPLATE == element.getType();
    }
}
