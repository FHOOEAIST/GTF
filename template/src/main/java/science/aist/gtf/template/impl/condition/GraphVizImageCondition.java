...
/**
 * <p>GraphViz Condition</p>
 *
 * @author Andreas Pointner
 * @since 1.0
 */
public class GraphVizImageCondition implements RendererCondition<TemplateTask> {
    @Override
    public Predicate<TemplateTask> createCondition() {
        return element -> TemplateTaskTypeEnum.GRAPHVIZ == element.getType();
    }
}
