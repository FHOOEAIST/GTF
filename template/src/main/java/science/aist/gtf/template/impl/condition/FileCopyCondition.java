...
/**
 * <p>Renderer condition for copying files</p>
 *
 * @author Andreas Schuler
 * @since 1.0
 */
public class FileCopyCondition implements RendererCondition<TemplateTask> {
    @Override
    public Predicate<TemplateTask> createCondition() {
        return element -> TemplateTaskTypeEnum.COPY == element.getType();
    }
}
