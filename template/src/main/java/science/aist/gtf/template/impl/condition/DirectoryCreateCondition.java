...
/**
 * <p>Renderer Condition for create a directory</p>
 *
 * @author Andreas Schuler
 * @since 1.0
 */
public class DirectoryCreateCondition implements RendererCondition<TemplateTask> {

    @Override
    public Predicate<TemplateTask> createCondition() {
        return element -> TemplateTaskTypeEnum.MKDIR == element.getType();
    }
}
