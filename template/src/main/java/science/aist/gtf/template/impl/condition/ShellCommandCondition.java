...
/**
 * <p>Condition for Shell rendering task</p>
 *
 * @author Andreas Pointner
 * @since 1.0
 */
public class ShellCommandCondition implements RendererCondition<TemplateTask> {
    @Override
    public Predicate<TemplateTask> createCondition() {
        return element -> TemplateTaskTypeEnum.SHELL == element.getType();
    }
}